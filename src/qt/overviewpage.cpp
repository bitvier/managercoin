    ...
    filter(0)
{
    ...
    ui->labelWalletStatus->setText("(" + tr("Out of sync with the managercoin network") + ")");
    ui->labelTransactionsStatus->setText("(" + tr("Out of sync with the managercoin network") + ")");
...
void OverviewPage::setModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("managercoin")
    updateDisplayUnit();
}
