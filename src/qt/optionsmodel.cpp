...
void OptionsModel::Init()
{
    ...
    fUsemanagercoinTheme = settings.value("fUsemanagercoinTheme", true).toBool();	
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case UsemanagercoinTheme:
            return QVariant(fUsemanagercoinTheme);			
        default:
            return QVariant();
        }
    }
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
            ...
            break;
        case UsemanagercoinTheme:
            fUsemanagercoinTheme = value.toBool();
            settings.setValue("fUsemanagercoinTheme", fUsemanagercoinTheme);
            break;			
        default:
            break;
        }
